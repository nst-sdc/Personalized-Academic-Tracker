...
const Sidebar = ({ darkMode }) => {
  ...
  return (
    <aside
      className={`w-[118px] h-screen flex justify-center overflow-hidden transition-all duration-500 ease-in-out ${bgColor} 
        border-r ${darkMode ? "border-gray-800" : "border-gray-100"} shadow-lg`}
    >
